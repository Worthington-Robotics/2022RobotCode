...
namespace robot {
    ...
    public:
        ...
        void lightModeCallback(const IntMsg msg);
    private:
        ...
        void setAngleOffset(const FloatMsg);
        void setRange(const FloatMsg);
        ...
        ROS_SUB(IntMsg) LightModeSub;
        ROS_SUB(FloatMsg) angleOffsetSub;
        ROS_SUB(FloatMsg) rangeSub;
